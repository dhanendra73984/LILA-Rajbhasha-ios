...
const Ministryprabodh = (props:any) => {
  ...
  const titleofministry = langWiseWords[43];
    ...
    const fetchVocabularyData = async () => {
      try {
        const response = await axios.post('https://lilaonmobile.rb-aai.in/LILAWebAPI/api/Home/getVocabularyData/', {
          ...
          GenCategory: 'Ministries',
          SectionName: 'Ministries',
        },{timeout:500000});
...
<SafeAreaView style={{ backgroundColor: '#0D6EFD' }}>  
       <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{titleofministry}</Text>
...
export default Ministryprabodh
