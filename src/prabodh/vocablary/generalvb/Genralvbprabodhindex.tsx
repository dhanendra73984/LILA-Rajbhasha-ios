import { Button, FlatList, Image, ImageBackground, LogBox, SafeAreaView, StyleSheet, Text, TouchableOpacity, View } from 'react-native'
...
const styles = StyleSheet.create({
    ...
    itemContainer: {
      ...
      width: '60%', // Adjust the width for a 3x3 grid
    },
    imageforcard: {
