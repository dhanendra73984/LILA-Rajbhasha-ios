import { FlatList, Image, ImageBackground, LogBox, SafeAreaView, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native'
...
// Function to get image source based on WordPic
  ...
  const renderItem = ({ item, index }: { item: string; index: number }) => (
    <TouchableOpacity onPress={() => handleImagePress(index)}>
      <Image key={index} style={styles.imageStyle} source={getImageByWordPic(item) } />
    </TouchableOpacity>
  );
