...
const Designationprabodh = (props:any) => {
  ...
  const titleofdesignation = langWiseWords[17];
    ...
    const fetchVocabularyData = async () => {
      try {
        const response = await axios.post('https://lilaonmobile.rb-aai.in/LILAWebAPI/api/Home/getVocabularyData/', {
          ...
          GenCategory: 'Designations',
          SectionName: 'Designations',
        },{timeout:500000});
...
<SafeAreaView style={{ backgroundColor: '#0D6EFD' }}>
       <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{titleofdesignation}</Text>
    ...
    style={styles.backgroundImage}>
      ...
      />
        ...
        <View>            
        {/* <Text>Ministry of prabodh are handele here with pop up handling ... </Text> */}
        </View>
...
export default Designationprabodh
