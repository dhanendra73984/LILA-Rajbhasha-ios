  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const total = 3; // Change this to the actual total number of pages
        setTotalPages(total);

        const response = await axios.get(
          `https://lilaonmobile.rb-aai.in/LILAMobileData/${Package}/Alphabet/${Medium}/Word_Formation_${currentPage}.html`,{timeout:500000}
        );
