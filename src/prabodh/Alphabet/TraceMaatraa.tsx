...
const TraceMaatraa = (proos:any) => {

  const hindiAlphabets = [
     'आ', 'इ', 'ई', 'उ', 'ऊ', 'ऋ', 'ए', 'ऐ', 'ओ', 'औ','अं','अः'
  ];
  ...
  const renderItem = ({ index }: { index: number }) => {
    const handleItemPress = () => {
      const videoUrl = `https://lilaonmobile.rb-aai.in/LILAMobileData/Prabodh/Alphabet/Video/Maatra${index + 1}.mp4`;
