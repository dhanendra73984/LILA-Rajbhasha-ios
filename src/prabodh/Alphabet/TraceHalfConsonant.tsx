...
const TraceHalfConsonant = (proos:any) => {

  const hindiAlphabets = [
    
    'क', 'ख', 'ग', 'घ', 'च',  'ज', 'ण', 'त', 'थ', 'द', 'ध', 'न',
  ...
  const renderItem = ({ index }: { index: number }) => {
    const handleItemPress = () => {
      const videoUrl = `https://lilaonmobile.rb-aai.in/LILAMobileData/Prabodh/Alphabet/Video/Half_Consonant${index + 1}.mp4`;
...
export default TraceHalfConsonant;
