...
const Testjumbleinstruction = (props: any) => {
  const { ApiResponse, Package, Medium, selectedLessonIndex, title,correctAnswersCountoffillintheblacks } = props.route.params;
  ...
  const renderInitialIntro = () => {
    const fillInTheBlanksData = instructionData.find((item) => item.SectionName === 'JumbleSentences');
  ...
  const handleProceedPress = () => {
    props.navigation.navigate('Testjumbleprabodh', {
      ApiResponse,
      Package,
      Medium,
      selectedLessonIndex,
...
<SafeAreaView style={{ backgroundColor: '#0D6EFD' }}>
    ...
    <ImageBackground
      ...
      style={styles.backgroundImage}>
             ...
             <Text style={styles.title}>{titleoflessonindex}{':'}{selectedLessonIndex}</Text>
...
export default Testjumbleinstruction;
