...
const Practiceprabodh = (props:any) => {
  ...
  const Sectiontitle = langWiseWords[55];
    ...
    const fetchData = async () => {
      try {
        const response = await axios.post(
          'https://lilaonmobile.rb-aai.in/LILAWebAPI/api/Home/getPractice/',
          {
            LangSelected: Medium,
            packagename: Package,
...
export default Practiceprabodh
