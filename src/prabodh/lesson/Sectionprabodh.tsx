...
const Sectionprabodh = (props:any) => {
    ...
    const handleListItemPress = (title: string) => {
      ...
      const componentMapping: { [key: string]: string } = {
        [langWiseWords[46]]: 'Objectiveprabodh',
        [langWiseWords[51]]: 'Structureprabodh',
        [langWiseWords[52]]: 'Narrativeprabodh',
        [langWiseWords[53]]: 'Newwordprabodh',
        [langWiseWords[54]]: 'Wordfamilyprabodh',
        [langWiseWords[20]]: 'Grammerprabodh',
        [langWiseWords[55]]: 'Practiceprabodh',
        [langWiseWords[13]]: Package === 'Prabodh' ? 'Excerciseprabodh' : 'Excercisepraveen',
        [langWiseWords[56]]:  Package === 'Prabodh' ? 'Testproceedprabodh': 'Testproceedpraveen',
