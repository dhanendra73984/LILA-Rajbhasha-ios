...
const Teststartprabodh = (props: any) => {
  ...
  useEffect(() => {
    const backHandler = BackHandler.addEventListener('hardwareBackPress', () => {
      ...
      props.navigation.navigate('Testproceedprabodh',{ApiResponse, Package, Medium, selectedLessonIndex,title,});
  ...
  const renderInitialIntro = () => {
    const fillInTheBlanksData = instructionData.find((item) => item.SectionName === 'FillInTheBlanks');
  ...
  const handleProceedPress = () => {
    props.navigation.navigate('Testsaction', {
      ApiResponse,
      Package,
      Medium,
      selectedLessonIndex,
...
export default Teststartprabodh;
