...
const Dictionarylistpragya = (props:any) => {
  ...
  const [meaningData, setMeaningData] = useState<any>(null);
          ...
          const handleHomePress = () => {
           //we have to send this once agin to Homepragya screen because it need this parameter
...
export default Dictionarylistpragya
