...
const Sampleletterspraggya = (props: any) => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `https://lilaonmobile.rb-aai.in/LILAMobileData/Pragya/SampleLetters/SampleLetter${selectedLessonIndex}_${currentPage}.htm`,{timeout:500000}
        );
...
export default Sampleletterspraggya;
