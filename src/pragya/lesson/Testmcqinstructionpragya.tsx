...
const Testmcqinstructionpragya = (props: any) => {
  const { ApiResponse, Package, Medium,  selectedLessonIndex,  title ,modifiedArray,originalExercisesTables,
    trueFalseCounter1,
  ...
  const handleProceedPress = () => {
    ...
    props.navigation.navigate('Testmcqpragya', {
...
export default Testmcqinstructionpragya;
