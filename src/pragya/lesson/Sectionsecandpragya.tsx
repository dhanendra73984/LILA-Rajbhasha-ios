...
const Sectionsecandpragya = (props:any) => {
    ...
    const indexesToShow = [46,277,278,260,279,55,280,281,13,56];
    ...
    const handleListItemPress = (title: string) => {
      ...
      const componentMapping: { [key: string]: string } = {
        ...
        [langWiseWords[277]]: 'Structureexposurepragya',
        [langWiseWords[278]]: 'Contenttextpragya',
        [langWiseWords[260]]: 'Vocabularypragya',
        [langWiseWords[279]]: 'Sentencepatternpragya',
        [langWiseWords[280]]: 'Sampleletterspraggya',
            
        [langWiseWords[55]]: 'Practicepragya',
        [langWiseWords[281]]: 'Situtationspragya',
        [langWiseWords[13]]:'Exerciselistpragya' ,
        [langWiseWords[56]]:'Testproceedpragya' ,
...
export default Sectionsecandpragya
