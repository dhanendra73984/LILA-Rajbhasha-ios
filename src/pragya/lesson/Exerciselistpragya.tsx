...
const Exerciselistpragya = (props:any) => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.post(
        ...
        {
          LangSelected: Medium,
          packagename: Package,//custmise this if needed
  ...
  const handleItemPress = (exercise: any,index: number) => {
    ...
    // Extracting category
    const regex = new RegExp(`Pragyath${selectedLessonIndex}(.*)`);//when you add pragya and praveen then  simplfy that also...............
    // const regex = new RegExp(`Praveenth${selectedLessonIndex}(.*)`);
    ...
    if (extractedWord.startsWith('FillClues')) {
      ...
      props.navigation.navigate('Fillinthecluespragya', {
      ...
      props.navigation.navigate('Excercisepragya', {
        exerciseName: exercise.Exercise_name,
        exerciseContent: exerciseContent,
        ApiResponse,
        Package,
      ...
      // Navigate to Fillintheblack component
      props.navigation.navigate('Translationpragya', {
        exerciseName: exercise.Exercise_name,
        exerciseContent: exerciseContent,
        ApiResponse,
        Package,
      ...
      props.navigation.navigate('Transformpragya', {
        exerciseName: exercise.Exercise_name,
        exerciseContent: exerciseContent,
        ApiResponse,
        Package,
    ...
    <View style={{flex:1}}>
      <SafeAreaView style={{ backgroundColor: '#0D6EFD' }}>   
        ...
        style={styles.backgroundImage}>
             ...
             <FlatList
              data={exercises
                .filter(item => item[`${Medium}Exercise`] !== null)}
...
export default Exerciselistpragya
