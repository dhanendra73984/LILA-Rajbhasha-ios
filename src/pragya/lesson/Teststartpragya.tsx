...
const Teststartpragya = (props: any) => {
  const { ApiResponse, Package, Medium, selectedLessonIndex, title ,modifiedArray,originalExercisesTables} = props.route.params;
          ...
          try {
            ...
            const fillInTheBlanksData = instructionData.find((item: { SectionName: any; }) => {
              ...
              if (modifiedArray.length > 0) {
                ...
                if (firstIndexValue === 'TestChoiceClue' && sectionName === 'FillInTheBlanks') {
                  return true;
  ...
  const handleProceedPress = () => {
    ...
    props.navigation.navigate('Tesxtpragya', {
      ApiResponse, Package, Medium, selectedLessonIndex,  title ,modifiedArray,originalExercisesTables,fillInTheBlanksData});
  };
  // const handleProceedPress = () => {
  ...
  useEffect(() => {
    const backHandler = BackHandler.addEventListener('hardwareBackPress', () => {
      ...
      props.navigation.navigate('Testproceedpragya',{ApiResponse, Package, Medium, selectedLessonIndex,title,});
...
export default Teststartpragya;
