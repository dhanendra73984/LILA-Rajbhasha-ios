...
const Transformpragya = (props: any) => {
  const {
    exerciseName,
    exerciseContent,
    ApiResponse,
  ...
  //fetching just excercise number 
  ...
  const handleShowCorrectAnswer = () => {
     const correctAnswer = fillCluesData[currentIndex].HAnswer;   
      ...
      // Set the state to indicate that the correct answer is shown
       };
  ...
  return (
    ...
    <View style={{ flex: 1 }}>
      ...
      {fillCluesData.length > 0 && (  <Text style={styles.instruction}>{fillCluesData[currentIndex].HModel}</Text> )}
...
export default Transformpragya
