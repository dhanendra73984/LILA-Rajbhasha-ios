...
const Karylayintippani = (props:any) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.post('https://lilaonmobile.rb-aai.in/LILAWebAPI/api/Home/getOfficeNotings', {
          LangSelected: Medium,
        },{timeout:500000});
...
export default Karylayintippani;
