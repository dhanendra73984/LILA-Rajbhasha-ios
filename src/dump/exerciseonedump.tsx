import { Image, ImageBackground, LogBox, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native'
  ...
  return (
    ...
    <View style={{flex:1}}>
     ...
     <View style={styles.header}>
        ...
        {/* Render random four images */}
        {randomImages.map((wordPic, index) => (
        <Image key={index} style={styles.imageStyle} source={getImageByWordPic(wordPic) || require('../../../../assets/img/baagh.jpg')} />
      ))}
