...
function Alphabet(props:any) {
  ...
  <Drawer.Screen
    ...
    options={({ navigation }) => ({
      drawerLabel: () => (
        <ImageBackground
          source={require('../../../assets/img/bg.jpg')}//when it dosnt load then plese chnage it into .png
          style={{
        ...
        >
          <Text style={{ color: 'black', fontSize: 18, margin: 12 }}>
            {langWiseWords[256]}
          </Text>
        </ImageBackground>
      ),
  ...
  />
        ...
        {/* Extra list items just for scrolling purpose remove it when alphabet works is finished ..........start */}
         ...
         <Drawer.Screen
          name="extra list item dosnt work"
        ...
        />
           ...
           <Drawer.Screen
          name="extra list 2 item dosnt work"
          component={TracePractice}
          options={{
            drawerLabel: () => (
              <ImageBackground
