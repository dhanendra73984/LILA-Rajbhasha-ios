...
const Testtruefalsepraveen = (props: any) => {
  const { ApiResponse, Package, Medium,  selectedLessonIndex, orignalessonindex, title ,modifiedArray,originalExercisesTables,
    ...
    testChoiceCounter2,
    trueFalseCounter2,} = props.route.params;
          ...
          try {
            ...
            const fillInTheBlanksData = instructionData.find((item: { SectionName: any; }) => {
              ...
              if (modifiedArray.length > 0) {
                const firstIndexValue = modifiedArray[2];
  ...
  const handleProceedPress = () => {
    ...
    props.navigation.navigate('Testtrufalsestart', {
...
export default Testtruefalsepraveen;
