...
const Excercisepraveen = (props:any) => {
  ...
  const handleItemPress = (exercise: any,index: number) => {
    ...
    // Extracting category
    const regex = new RegExp(`Praveenth${selectedLessonIndex}(.*)`);//when you add pragya and praveen then  simplfy that also...............
...
export default Excercisepraveen
