...
const Testmcqinstructionpraveen = (props: any) => {
  const { ApiResponse, Package, Medium,  selectedLessonIndex, orignalessonindex, title ,modifiedArray,originalExercisesTables,
    trueFalseCounter1,
    fillInBlanksCounter1,
    testChoiceCounter1,} = props.route.params;
          ...
          try {
            ...
            const fillInTheBlanksData = instructionData.find((item: { SectionName: any; }) => {
              ...
              if (modifiedArray.length > 0) {
                const firstIndexValue = modifiedArray[1];
  ...
  const handleProceedPress = () => {
    ...
    props.navigation.navigate('Testmcqpraveen', {
...
export default Testmcqinstructionpraveen;
